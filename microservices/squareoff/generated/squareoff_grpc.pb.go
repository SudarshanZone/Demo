...
const (
	SquareOffService_SquareOffOrder_FullMethodName = "/squareoff.SquareOffService/SquareOffOrder"
)
...
var SquareOffService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "squareoff.SquareOffService",
